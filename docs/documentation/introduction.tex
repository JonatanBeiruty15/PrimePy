...
\texttt{PrimePy} is a Python number theory library with C++ backend, designed for high-performance computation and symbolic experimentation.
...
\end{enumerate}
The PrimePy project is guided by the following Philosophy:
\begin{itemize}
...
\texttt{PrimePy} is designed with several principles in mind:

\paragraph{1. Data Types — Precision Over Approximation}  
\textcolor{red}{TODO}
