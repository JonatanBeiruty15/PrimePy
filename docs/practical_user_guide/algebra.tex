...
\subsection{Additive Group Modulo \texorpdfstring{$n$}{n}(\texorpdfstring{$\mathbb{Z}/n\mathbb{Z}$}{Z/nZ})}
...
\subsection{Ring of Integers Modulo \texorpdfstring{$n$}{n}(\texorpdfstring{$\mathbb{Z}/n\mathbb{Z}$}{Z/nZ})}
...
Pass a list/tuple of integers and get back a list of booleans. This uses the same
